...
public class TestSimpleOomage {
    ...
    public void testHashCodePerfect() {
         ...
         */
        SimpleOomage example = SimpleOomage.randomSimpleOomage();
        int hashcode = example.hashCode();
        for (int i = 0; i < 50000; i++) {
            SimpleOomage com = SimpleOomage.randomSimpleOomage();
            if (!com.equals(example)) {
                assertNotEquals(com.hashCode(), hashcode);
                /*
                if (com.hashCode() == hashcode) {
